...
public class XlsWriter {
    ...
    public static void createAndWriteTable(List<Statistics> statisticsList, String pathname) {
        ...
        log.info("Таблица статистики успешно создана");
        ...
        log.info("Успешно добавлено в таблицу статистики - " + statisticsList.size() + " строк");
        // запись в файл
        ...
        try {
            ...
            log.info("Файл статистики успешно создан и записан");
        } catch (IOException e) {
            log.severe("Ошибка создания и записи файла статистики");
            e.printStackTrace();
        }
    }
}
